...
- [ ] **AM/PM 분할**: 4시간 이상 또는 다일 강의 시 오전/오후 구분이 되어 있는가? 세션이 50분 단위로 구성되고 쉬는 시간 10분이 명시되었는가?
...
- [ ] **EXTERNAL_TOOL 카테고리**: EXTERNAL_TOOL 이벤트의 `category`가 해당 에이전트의 AGENTS.md §Per-Agent Model Routing 매핑과 일치하는가?
