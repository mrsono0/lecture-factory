...
`@lecture-planner` 에이전트에게 위임하여 01_Lecture_Planning 파이프라인을 실행합니다.
...
> 💡 인수 없이 실행하면 A0_Orchestrator의 brainstorming 프로세스가 시작됩니다. 상세 동작은 `A0_Orchestrator.md` §Phase 2를 참조하세요.
